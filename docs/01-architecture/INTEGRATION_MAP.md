---
title: "R3almHeadlessSMTP — Integration Map"
...
| Primary data store | Bidirectional | message content, recipient identifiers, delivery state, and operational metadata | Workload identity / secret | Data owner | TBD |
