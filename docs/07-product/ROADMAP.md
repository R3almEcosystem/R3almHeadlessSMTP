---
title: "R3almHeadlessSMTP — Roadmap"
...
| 1 — Core workflow | compose or ingest → validate → deliver → observe works end to end in an isolated environment | Acceptance and failure-path tests | Planned |
